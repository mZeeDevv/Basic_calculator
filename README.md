...
## What is eval() for?
eval() JS built-in function that evaluates a string as JavaScript code and executes it.It takes a string as an argument and dynamically interprets that string.
